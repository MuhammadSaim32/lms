        ...
        {({ values, errors, touched }) => (
          <Form className=" h-full mt-9 ">
              ...
              {({ push, remove }) => (
                <div>
                  {values.Sections.map((section, index) => (
                    <div
                      key={index}
                      className="flex flex-col w-full min-w-2xl  item-center justify-center"
                    >
                          ...
                          {({ push: pushItem, remove: removeItem }) => (
                            <>
                              {section.SectionItems.map((item, iIndex) => (
                                <div
                                  key={iIndex}
                                  className="flex flex-col items-center w-full h-full gap-3 bg-gray-300"
                                >
            ...
            <div className="flex justify-between mt-4 mb-4">
              <button
                type="button"
                className="cursor-pointer bg-purple-700 p-2 px-6 rounded text-white"
                onClick={() => setStep(2)}
              >
                Previous
              </button>
