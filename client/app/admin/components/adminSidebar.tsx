...
export default function AdminSideBar() {
    ...
    return active ? <div className="h-full  w-[20%] bg-slate-900 flex-col flex items-center overflow-auto text-white scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-800  border-r-2">
