...
import { deleteUser, updateRole, getAllUsers, registerUser, activateUser, loginUser, logoutUser, updateRefreshToken, getUserProfile, socailLogin, updateUserProfile, updatePassword, updateAvatar ,githubAuth} from "../controllers/user.controller.js"
